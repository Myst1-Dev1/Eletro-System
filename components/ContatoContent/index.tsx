...
export function ContatoContent() {
    ...
    function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        const textoPuro =
            `Olá, EletroSystem! Gostaria de entrar em contato.\n\n` +
            ...
            `*MENSAGEM:*\n` +
            `${iconMessage} ${mensagem}\n\n` +

            (file && file.size > 0
                ? `${iconAttachment} *Possui anexo:* ${file.name}\n`
                : "");
                    ...
                    <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="group space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <textarea
                                    name="mensagem"
                                    placeholder="Descreva seu problema e como podemos ajudar"
                                    rows={5}
